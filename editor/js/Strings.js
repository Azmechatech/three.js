...
var Strings = function ( config ) {
	...
	var values = {
		...
		en: {
			...
			'menubar/eng': 'Engineering',
			'menubar/eng/group': 'Group',
			'menubar/eng/plane': 'Plane',
			'menubar/eng/box': 'Box',
			'menubar/eng/circle': 'Circle',
			'menubar/eng/cylinder': 'Cylinder',
			'menubar/eng/ring': 'Ring',
			'menubar/eng/sphere': 'Sphere',
			'menubar/eng/dodecahedron': 'Dodecahedron',
			'menubar/eng/icosahedron': 'Icosahedron',
			'menubar/eng/octahedron': 'Octahedron',
			'menubar/eng/tetrahedron': 'Tetrahedron',
			'menubar/eng/torus': 'Torus',
			'menubar/eng/tube': 'Tube',
			'menubar/eng/torusknot': 'TorusKnot',
			'menubar/eng/lathe': 'Lathe',
			'menubar/eng/sprite': 'Sprite',
			'menubar/eng/pointlight': 'PointLight',
			'menubar/eng/spotlight': 'SpotLight',
			'menubar/eng/directionallight': 'DirectionalLight',
			'menubar/eng/hemispherelight': 'HemisphereLight',
			'menubar/eng/ambientlight': 'AmbientLight',
			'menubar/eng/perspectivecamera': 'PerspectiveCamera',
			'menubar/eng/orthographiccamera': 'OrthographicCamera',
